...
if not errorlevel 1 (
    ...
    echo ⚠️ 系统PATH中的Java版本过低:
    type temp_version.txt
    del temp_version.txt >nul 2>&1
)

:: 如果没有找到合适的Java版本，提示用户
echo.
...
echo.
echo 💡 系统启动后，请访问: http://localhost:8088
echo.
echo 🔑 默认管理员账号:
echo    用户名: root
echo    密码: 123456
